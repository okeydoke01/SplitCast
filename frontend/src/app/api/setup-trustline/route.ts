...
const KNOWN_TEST_KEYS: Record<string, string> = {
  ...
  'GA22NVWIW47LEOMLOYUJVOS3SO3CEAJKKJFU4JYKYAO3S2LN7NRDEXAT': 'SDTUGKEUXTXRO3KABSN6UMKZJ36MDU7MWAEQEJJ6VRAI3NR6HRYPXH2U', // merchant
  'GC2XFFGJHQMJGVPBE4NQHTTWK7DXC2DKMBED2K7NEL2UPDPTGMEBIGSE': 'SC7M76AYY4CNH4RDUG45ISCERT4GABZEGNANVFJYLUA2T5AGFEV6I4DQ', // subscriber
...
export async function POST(request: Request) {
  try {
    ...
    if (recipientSecret) {
      ...
      // Custom testnet recipient: Sponsor trustline entry via split_admin
